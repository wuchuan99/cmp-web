!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e) {
        ...
        if ("[object Array]" === n) {
          ...
          if (!c(t)) {
            ...
            if (t.constructor.from) e = o.from(t);
              ...
              e = new o(t.length);
              for (i = 0, a = t.length; i < a; i++) e[i] = r(t[i]);
            }
          }
        } else if (!d[n] && !c(t) && !u(t))
          for (var s in ((e = {}), t)) t.hasOwnProperty(s) && (e[s] = r(t[s]));
        return e;
      }
      function n(t, e, i) {
        if (!l(e) || !l(t)) return i ? r(e) : t;
        for (var a in e)
      ...
      function a(t, e, r) {
        if (t && e)
          if (t.forEach && t.forEach === y) t.forEach(e, r);
      ...
      function f(t) {
        ...
        this.data = {};
        var n = this;
        t instanceof f ? t.each(e) : t && a(t, e);
      }
      var d = {
          "[object Function]": 1,
          "[object RegExp]": 1,
      ...
      (f.prototype = {
        ...
        each: function(t, e) {
          for (var r in (void 0 !== e && (t = o(t, e)), this.data))
        ...
        (e.inherits = function(t, e) {
          function r() {}
          var n = t.prototype;
          for (var i in ((r.prototype = e.prototype),
          (t.prototype = new r()),
          n))
            t.prototype[i] = n[i];
        ...
        (e.map = function(t, e, r) {
          if (t && e) {
            if (t.map && t.map === _) return t.map(e, r);
        ...
        (e.reduce = function(t, e, r, n) {
          if (t && e) {
            if (t.reduce && t.reduce === b) return t.reduce(e, r, n);
        ...
        (e.filter = function(t, e, r) {
          if (t && e) {
            if (t.filter && t.filter === m) return t.filter(e, r);
            for (var n = [], i = 0, a = t.length; i < a; i++)
    ...
    function(t, e, r) {
      ...
      var i = r(7),
        ...
        o = r(9),
        s = r(52),
        l = r(58).prototype.getCanvasPattern,
        h = Math.abs,
        u = new o(!0);
      (n.prototype = {
        constructor: n,
        ...
        brush: function(t, e) {
          ...
          (n.bind(t, this, e), this.setTransform(t), this.__dirty) &&
            (c &&
              ...
              (this._fillGradient = n.getGradient(t, s, r))),
            f &&
              ((r = r || this.getBoundingRect()),
              (this._strokeGradient = n.getGradient(t, h, r))));
          c
            ? (t.fillStyle = this._fillGradient)
            : d && (t.fillStyle = l.call(s, t)),
            f
              ? (t.strokeStyle = this._strokeGradient)
              : p && (t.strokeStyle = l.call(h, t));
          var v = n.lineDash,
            g = n.lineDashOffset,
            y = !!t.setLineDash,
          ...
          if (
            ...
            this.__dirtyPath || (v && !y && a)
              ? (i.beginPath(t),
                v && !y && (i.setLineDash(v), i.setLineDashOffset(g)),
    ...
    function(t, e) {
      ...
      var o = "undefined" == typeof Float32Array ? Array : Float32Array,
        s = r,
        l = n,
        h = i,
        u = a;
      (e.create = function(t, e) {
        ...
        (e.min = function(t, e, r) {
          return (
            (t[0] = Math.min(e[0], r[0])), (t[1] = Math.min(e[1], r[1])), t
          );
        }),
        (e.max = function(t, e, r) {
          return (
            (t[0] = Math.max(e[0], r[0])), (t[1] = Math.max(e[1], r[1])), t
          );
        });
    },
    function(t, e, r) {
    ...
    function(t, e, r) {
      ...
      (e.cubicAt = a),
        ...
        (e.cubicRootAt = function(t, e, r, i, a, o) {
          var s = i + 3 * (e - r) - t,
            l = 3 * (r - 2 * e + t),
            h = 3 * (e - t),
            f = t - a,
          ...
          if (n(d) && n(g))
            ...
            if (n(x)) {
              ...
              var M = (2 * d * l - 3 * s * g) / (2 * c(d * d * d)),
                P = Math.acos(M) / 3,
                k = c(d),
                O = Math.cos(P),
                C = (-l - 2 * k * O) / (3 * s),
                A =
                  ((b = (-l + k * (O + p * Math.sin(P))) / (3 * s)),
                  (-l + k * (O - p * Math.sin(P))) / (3 * s));
              C >= 0 && C <= 1 && (o[m++] = C),
                b >= 0 && b <= 1 && (o[m++] = b),
                A >= 0 && A <= 1 && (o[m++] = A);
            }
        ...
        (e.cubicExtrema = function(t, e, r, a, o) {
          var s = 6 * r - 12 * e + 6 * t,
            l = 9 * e + 3 * a - 3 * t - 9 * r,
            h = 3 * e - 3 * t,
            u = 0;
          if (n(l)) i(s) && (d = -h / s) >= 0 && d <= 1 && (o[u++] = d);
          else {
            var f = s * s - 4 * l * h;
            if (n(f)) o[0] = -s / (2 * l);
            else if (f > 0) {
        ...
        (e.cubicProjectPoint = function(t, e, r, n, i, o, s, l, u, f, p) {
          var v,
            x,
            _,
            b,
            ...
            (x = v - S),
              ...
              x >= 0 && b < T
                ...
                : ((m[0] = a(t, r, i, s, _)),
                  (m[1] = a(e, n, o, l, _)),
                  (w = h(m, g)),
                  _ <= 1 && w < T ? ((v = _), (T = w)) : (S *= 0.5));
          return (
            p && ((p[0] = a(t, r, i, s, v)), (p[1] = a(e, n, o, l, v))), c(T)
          );
        }),
        (e.quadraticAt = o),
        ...
        (e.quadraticRootAt = function(t, e, r, a, o) {
          var s = t - 2 * e + r,
            l = 2 * (e - t),
            h = t - a,
            u = 0;
          if (n(s)) i(l) && (d = -h / l) >= 0 && d <= 1 && (o[u++] = d);
          else {
            var f = l * l - 4 * s * h;
            if (n(f)) (d = -l / (2 * s)) >= 0 && d <= 1 && (o[u++] = d);
            else if (f > 0) {
              var d,
                p = c(f),
                v = (-l - p) / (2 * s);
              (d = (-l + p) / (2 * s)) >= 0 && d <= 1 && (o[u++] = d),
                v >= 0 && v <= 1 && (o[u++] = v);
            }
          }
          return u;
        ...
        (e.quadraticProjectPoint = function(t, e, r, n, i, a, s, l, u) {
          var f,
            p = 0.005,
            v = 1 / 0;
          (g[0] = s), (g[1] = l);
          for (var x = 0; x < 1; x += 0.05)
            (y[0] = o(t, r, i, x)),
              ...
              (S = h(g, y)) < v && ((f = x), (v = S));
          v = 1 / 0;
          for (var _ = 0; _ < 32 && !(p < d); _++) {
            var b = f - p,
              w = f + p;
            (y[0] = o(t, r, i, b)), (y[1] = o(e, n, a, b));
            var S = h(y, g);
            if (b >= 0 && S < v) (f = b), (v = S);
            else {
              (m[0] = o(t, r, i, w)), (m[1] = o(e, n, a, w));
              var T = h(m, g);
              w <= 1 && T < v ? ((f = w), (v = T)) : (p *= 0.5);
            }
          }
          return u && ((u[0] = o(t, r, i, f)), (u[1] = o(e, n, a, f))), c(v);
        });
    },
    function(e, r) {
      e.exports = t;
      ...
      (_.prototype = {
        ...
        _dashedLineTo: function(t, e) {
          var r,
            ...
            m = o.length;
          for (
            u /= f, c /= f, a < 0 && (a = i + a), v -= (a %= i) * u, g -= a * c;
            (u > 0 && v <= t) ||
            (u < 0 && v >= t) ||
            (0 === u && ((c > 0 && g <= e) || (c < 0 && g >= e)));
        ...
        toStatic: function() {
          var t = this.data;
          t instanceof Array &&
            ((t.length = this._len), x && (this.data = new Float32Array(t)));
        },
        getBoundingRect: function() {
        ...
        (e.createOrUpdateImage = function(t, e, r, o, s) {
          if (t) {
            if ("string" == typeof t) {
              ...
              return (
                l
                  ? !i((e = l.image)) && l.pending.push(h)
                  : (((e = new Image()).onload = e.onerror = n),
                    a.put(t, (e.__cachedImgObj = { image: e, pending: [h] })),
    ...
    function(t, e, r) {
      ...
      (e.normalizeToArray = n),
        ...
        (e.getDataItemValue = function(t) {
          return !h(t) || u(t) || t instanceof Date ? t : t.value;
        }),
              ...
              if (h(t)) {
                for (var a = 0; a < r.length; a++)
                  if (
                    ...
                    return (r[a].option = t), void (e[n] = null);
        ...
        (e.makeIdAndName = function(t) {
          ...
          l(t, function(t, r) {
            ...
            l(t, function(t, r) {
              ...
              if (h(i)) {
                if (
                  ((a.name = null != i.name ? i.name + "" : n ? n.name : c + r),
                  n)
                )
                  a.id = n.id;
        ...
        (e.queryDataIndex = function(t, e) {
          return null != e.dataIndexInside
            ...
            ? o.isArray(e.dataIndex)
              ? o.map(e.dataIndex, function(e) {
                  return t.indexOfRawIndex(e);
                })
              : t.indexOfRawIndex(e.dataIndex)
            : null != e.name
            ? o.isArray(e.name)
              ? o.map(e.name, function(e) {
        ...
        (e.makeInner = function() {
          var t = "__\0ec_inner_" + f++ + "_" + Math.random().toFixed(5);
          return function(e) {
            return e[t] || (e[t] = {});
          };
        }),
        (e.parseFinder = function(t, e, r) {
          ...
          return (
            l(e, function(n, i) {
              if (((n = e[i]), "dataIndex" !== i && "dataIndexInside" !== i)) {
                ...
                if (
                  !(
                    ...
                    (r &&
                      r.includeMainTypes &&
                      o.indexOf(r.includeMainTypes, l) < 0)
                  )
                ) {
                  var u = { mainType: l };
                  ("index" === h && "all" === n) || (u[h] = n);
        ...
        (e.groupData = function(t, e) {
          var r = o.createHashMap(),
            n = [];
          return (
            o.each(t, function(t) {
              var i = e(t);
              (r.get(i) || (n.push(i), r.set(i, []))).push(t);
            }),
            { keys: n, buckets: r }
          );
        });
    ...
    function(t, e, r) {
      function n(t) {
        (this.fromDataset = t.fromDataset),
          ...
          (this.sourceFormat = t.sourceFormat || c),
          (this.seriesLayoutBy = t.seriesLayoutBy || u),
          (this.dimensionsDefine = t.dimensionsDefine),
          (this.encodeDefine = t.encodeDefine && a(t.encodeDefine)),
      ...
      var i = r(0),
        a = i.createHashMap,
        o = i.isTypedArray,
        s = r(36).enableClassCheck,
        l = r(15),
        h = l.SOURCE_FORMAT_ORIGINAL,
        u = l.SERIES_LAYOUT_BY_COLUMN,
        c = l.SOURCE_FORMAT_UNKNOWN,
        f = l.SOURCE_FORMAT_TYPED_ARRAY,
        d = l.SOURCE_FORMAT_KEYED_COLUMNS;
      (n.seriesDataToSource = function(t) {
        return new n({ data: t, sourceFormat: o(t) ? f : h, fromDataset: !1 });
      }),
        s(n);
      var p = n;
      t.exports = p;
    ...
    function(t, e, r) {
      ...
      var c = [],
        f = i.create();
      (h.setLocalTransform = function(t) {
        if (t) {
        ...
        (h.decomposeTransform = function() {
          if (this.transform) {
            var t = this.parent,
              e = this.transform;
            t && t.transform && (i.mul(c, t.invTransform, e), (e = c));
            var r = this.origin;
            r &&
              (r[0] || r[1]) &&
              ((f[4] = r[0]),
    ...
    function(t, e, r) {
      ...
      function f(t, e) {
        if (t) {
          ...
          if (n in y) return u(e, y[n]), c(t, e), e;
          if ("#" !== n.charAt(0)) {
            var i = n.indexOf("("),
              s = n.indexOf(")");
            if (-1 !== i && s + 1 === n.length) {
              var l = n.substr(0, i),
                f = n.substr(i + 1, s - (i + 1)).split(","),
                p = 1;
              switch (l) {
                case "rgba":
                  if (4 !== f.length) return void h(e, 0, 0, 0, 1);
                  p = o(f.pop());
                case "rgb":
                  return 3 !== f.length
                    ? void h(e, 0, 0, 0, 1)
                    : (h(e, a(f[0]), a(f[1]), a(f[2]), p), c(t, e), e);
                case "hsla":
                  return 4 !== f.length
                    ? void h(e, 0, 0, 0, 1)
                    : ((f[3] = o(f[3])), d(f, e), c(t, e), e);
                case "hsl":
                  return 3 !== f.length
                    ? void h(e, 0, 0, 0, 1)
                    : (d(f, e), c(t, e), e);
            ...
            var v;
            if (4 === n.length)
              return (v = parseInt(n.substr(1), 16)) >= 0 && v <= 4095
                ? (h(
                    e,
                    ((3840 & v) >> 4) | ((3840 & v) >> 8),
                    (240 & v) | ((240 & v) >> 4),
                ...
                : void h(e, 0, 0, 0, 1);
            if (7 === n.length)
              return (v = parseInt(n.substr(1), 16)) >= 0 && v <= 16777215
                ? (h(e, (16711680 & v) >> 16, (65280 & v) >> 8, 255 & v, 1),
                  c(t, e),
                  e)
                : void h(e, 0, 0, 0, 1);
          }
      ...
      function v(t, e, r) {
        if (e && e.length && t >= 0 && t <= 1) {
          ...
          return r ? { color: d, leftIndex: o, rightIndex: s, value: a } : d;
        }
      }
      function g(t, e) {
        if (t && t.length) {
      ...
      (e.parse = f),
        (e.lift = function(t, e) {
          ...
          if (r) {
            for (var n = 0; n < 3; n++)
              (r[n] =
                e < 0 ? (r[n] * (1 - e)) | 0 : ((255 - r[n]) * e + r[n]) | 0),
                r[n] > 255 ? (r[n] = 255) : t[n] < 0 && (r[n] = 0);
            return g(r, 4 === r.length ? "rgba" : "rgb");
          }
        }),
        (e.toHex = function(t) {
          var e = f(t);
        ...
        (e.modifyAlpha = function(t, e) {
          if ((t = f(t)) && null != e) return (t[3] = i(e)), g(t, "rgba");
        }),
        (e.stringify = g);
    },
    function(t, e) {
    ...
    function(t, e, r) {
      function n(t) {
        if (t) {
          ...
          var e = t.textAlign;
          "middle" === e && (e = "center"),
            (t.textAlign = null == e || A[e] ? e : "left");
          var r = t.textVerticalAlign || t.textBaseline;
          "center" === r && (r = "middle"),
            (t.textVerticalAlign = null == r || I[r] ? r : "top"),
      ...
      function a(t, e, r, n, i, a, l, h) {
        var d = n.rich[r.styleName] || {};
        d.text = r.text;
        var v = r.textVerticalAlign,
          m = a + i / 2;
        "top" === v
          ? (m = a + r.height / 2)
          : "bottom" === v && (m = a + i - r.height / 2),
          !r.isLineHolder &&
            o(d) &&
            s(
              t,
        ...
        var x = r.textPadding;
        x && ((l = p(l, h, x)), (m -= r.height / 2 - x[2] - r.textHeight / 2)),
          u(e, "shadowBlur", y(d.textShadowBlur, n.textShadowBlur, 0)),
          u(
            e,
            "shadowColor",
            d.textShadowColor || n.textShadowColor || "transparent"
          ),
          u(e, "shadowOffsetX", y(d.textShadowOffsetX, n.textShadowOffsetX, 0)),
          u(e, "shadowOffsetY", y(d.textShadowOffsetY, n.textShadowOffsetY, 0)),
          u(e, "textAlign", h),
          u(e, "textBaseline", "middle"),
          u(e, "font", r.font || C);
        var _ = c(d.textStroke || n.textStroke, w),
          b = f(d.textFill || n.textFill),
          w = g(d.textStrokeWidth, n.textStrokeWidth);
        _ &&
          (u(e, "lineWidth", w),
          u(e, "strokeStyle", _),
          e.strokeText(r.text, l, m)),
          b && (u(e, "fillStyle", b), e.fillText(r.text, l, m));
      }
      function o(t) {
        return !!(
      ...
      function s(t, e, r, n, i, a, o) {
        var s = r.textBackgroundColor,
          ...
          f = _(s);
        if (
          (u(e, "shadowBlur", r.textBoxShadowBlur || 0),
          u(e, "shadowColor", r.textBoxShadowColor || "transparent"),
          u(e, "shadowOffsetX", r.textBoxShadowOffsetX || 0),
          u(e, "shadowOffsetY", r.textBoxShadowOffsetY || 0),
          f || (h && c))
        ) {
          e.beginPath();
          var d = r.textBorderRadius;
          d
            ? S.buildPath(e, { x: n, y: i, width: a, height: o, r: d })
            : e.rect(n, i, a, o),
            e.closePath();
        }
        if (f)
          if ((u(e, "fillStyle", s), null != r.fillOpacity)) {
            var p = e.globalAlpha;
          ...
          var v = s.image;
          (v = T.createOrUpdateImage(v, null, t, l, s)) &&
            T.isImageReady(v) &&
            e.drawImage(v, n, i, a, o);
        }
        if (h && c)
          if (
            (u(e, "lineWidth", h),
      ...
      function h(t, e, r) {
        ...
        if (r) {
          ...
          if (s instanceof Array)
            (n = r.x + d(s[0], r.width)), (i = r.y + d(s[1], r.height));
          else {
            var l = w.adjustTextPositionOnRect(s, r, e.textDistance);
            (n = l.x),
              (i = l.y),
              (a = a || l.textAlign),
      ...
      var v = r(0),
        ...
        P = r(8),
        k = P.ContextCachedBy,
        O = P.WILL_BE_RESTORED,
        C = w.DEFAULT_FONT,
        A = { left: 1, right: 1, center: 1 },
      ...
      (e.normalizeTextStyle = function(t) {
        return n(t), m(t.rich, n), t;
      }),
        (e.renderText = function(t, e, r, n, l, u) {
          n.rich
            ? (function(t, e, r, n, l, u) {
                u !== O && (e.__attrCachedBy = k.NONE);
                var c = t.__textCotentBlock;
                (c && !t.__dirtyText) ||
                  (c = t.__textCotentBlock = w.parseRichText(r, n)),
                  (function(t, e, r, n, l) {
                    var u = r.width,
                      c = r.outerWidth,
                      f = r.outerHeight,
                      ...
                      g = p.baseY,
                      y = p.textAlign,
                      m = p.textVerticalAlign;
                    i(e, n, l, v, g);
                    var x = w.adjustTextX(v, c, y),
                      _ = w.adjustTextY(g, f, m),
                      b = x,
                      S = _;
                    d && ((b += d[3]), (S += d[0]));
                    var T = b + u;
                    ...
                    for (var M = 0; M < r.lines.length; M++) {
                      for (
                        var P,
                          ...
                          B = C - 1;
                        D < C &&
                        (!(P = O[D]).textAlign || "left" === P.textAlign);

                      )
                        a(t, e, P, n, A, S, R, "left"),
                          (I -= P.width),
                          (R += P.width),
                          D++;
                      for (; B >= 0 && "right" === (P = O[B]).textAlign; )
                        a(t, e, P, n, A, S, L, "right"),
                          (I -= P.width),
                          (L -= P.width),
                          B--;
                      for (R += (u - (R - b) - (T - L) - I) / 2; D <= B; )
                        (P = O[D]),
                          a(t, e, P, n, A, S, R + P.width / 2, "center"),
                          (R += P.width),
                          D++;
                      S += A;
                    }
            ...
            : (function(t, e, r, n, a, l) {
                "use strict";
                var u,
                  d = o(n),
                  v = !1,
                  g = e.__attrCachedBy === k.PLAIN_TEXT;
                l !== O
                  ? (l && ((u = l.style), (v = !d && g && u)),
                    (e.__attrCachedBy = d ? k.NONE : k.PLAIN_TEXT))
                  : g && (e.__attrCachedBy = k.NONE);
                var y = n.font || C;
                (v && y === (u.font || C)) || (e.font = y);
                var m = t.__computedFont;
                t.__styleFont !== y &&
                  ((t.__styleFont = y), (m = t.__computedFont = e.font));
                var x = n.textPadding,
                  _ = n.textLineHeight,
                  b = t.__textCotentBlock;
                (b && !t.__dirtyText) ||
                  (b = t.__textCotentBlock = w.parsePlainText(
                    r,
                    m,
                    x,
                    _,
                ...
                var S = b.outerHeight,
                  ...
                  R = A.baseY,
                  L = A.textAlign || "left",
                  B = A.textVerticalAlign;
                i(e, n, a, I, R);
                var E = w.adjustTextY(R, S, B),
                  F = I,
                  z = E;
                if (d || x) {
                  var N = w.getWidth(r, m),
                    W = N;
                  x && (W += x[1] + x[3]);
                  var q = w.adjustTextX(I, W, L);
                  d && s(t, e, n, q, E, W, S),
                    x && ((F = p(I, L, x)), (z += x[0]));
                }
                (e.textAlign = L),
                ...
                for (var j = 0; j < D.length; j++) {
                  var H = D[j],
                    ...
                    U = H[1],
                    V = n[Y];
                  (v && V === u[Y]) || (e[U] = M(e, U, V || H[2]));
                }
                z += P / 2;
                var G = n.textStrokeWidth,
                  X = v ? u.textStrokeWidth : null,
                  Z = !v || G !== X,
                  Q = !v || Z || n.textStroke !== u.textStroke,
                  $ = c(n.textStroke, G),
                  K = f(n.textFill);
                if (
                  ($ && (Z && (e.lineWidth = G), Q && (e.strokeStyle = $)),
                  K && ((v && n.textFill === u.textFill) || (e.fillStyle = K)),
                  1 === T.length)
                )
                  $ && e.strokeText(T[0], F, z), K && e.fillText(T[0], F, z);
                else
                  for (var j = 0; j < T.length; j++)
                    $ && e.strokeText(T[j], F, z),
                      K && e.fillText(T[j], F, z),
                      (z += P);
              })(t, e, r, n, l, u);
        }),
        (e.getStroke = c),
    ...
    function(t, e, r) {
      function n(t, e) {
        ...
        for (
          ...
          i = Math.max(d(n[a], e).width, i);
        return P > k && ((P = 0), (M = {})), P++, (M[r] = i), i;
      }
      ...
      function l(t, e, r, n, i) {
        ...
        var a = (t + "").split("\n");
        i = h(e, r, n, i);
        for (var o = 0, s = a.length; o < s; o++) a[o] = u(a[o], i);
        return a.join("\n");
      }
      function h(t, e, r, i) {
        (i = b({}, i)).font = e;
        r = w(r, "...");
        i.maxIterations = w(i.maxIterations, 2);
        var a = (i.minChar = w(i.minChar, 0));
        i.cnCharWidth = n("国", e);
        var o = (i.ascCharWidth = n("a", e));
        i.placeholder = w(i.placeholder, "");
      ...
      function u(t, e) {
        ...
        for (var s = 0; ; s++) {
          ...
          var l =
            0 === s
              ? c(t, a, e.ascCharWidth, e.cnCharWidth)
              : o > 0
              ? Math.floor((t.length * a) / o)
              : 0;
          o = n((t = t.substr(0, l)), i);
        }
      ...
      function p(t, e, r, n, i) {
        ...
        if ((r && (l += r[0] + r[2]), t && i)) {
          ...
          if (null != c && l > c) (t = ""), (o = []);
            ...
            for (
              var p = h(d - (r ? r[1] + r[3] : 0), e, i.ellipsis, {
                  minChar: i.minChar,
      ...
      function v(t, e) {
        ...
        for (var i, a = (O.lastIndex = 0); null != (i = O.exec(t)); ) {
          var o = i.index;
          o > a && g(r, t.substring(a, o)), g(r, i[2], i[1]), (a = O.lastIndex);
        }
        a < t.length && g(r, t.substring(a, t.length));
        var s = r.lines,
          h = 0,
          u = 0,
          c = [],
          ...
          v = p && p.outerWidth,
          y = p && p.outerHeight;
        d && (null != v && (v -= d[1] + d[3]), null != y && (y -= d[0] + d[2]));
        for (var x = 0; x < s.length; x++) {
          for (var _ = s[x], b = 0, T = 0, M = 0; M < _.tokens.length; M++) {
            var P = ((F = _.tokens[M]).styleName && e.rich[F.styleName]) || {},
              k = (F.textPadding = P.textPadding),
              C = (F.font = P.font || e.font),
              A = (F.textHeight = w(P.textHeight, f(C)));
            if (
              (k && (A += k[0] + k[2]),
              (F.height = A),
              (F.lineHeight = S(P.textLineHeight, e.textLineHeight, A)),
              (F.textAlign = (P && P.textAlign) || e.textAlign),
              (F.textVerticalAlign = (P && P.textVerticalAlign) || "middle"),
              null != y && h + F.lineHeight > y)
            )
              return { lines: [], width: 0, height: 0 };
            F.textWidth = n(F.text, C);
            var I = P.textWidth,
              D = null == I || "auto" === I;
            if ("string" == typeof I && "%" === I.charAt(I.length - 1))
              (F.percentWidth = I), c.push(F), (I = 0);
            else {
              if (D) {
                I = F.textWidth;
                var R = P.textBackgroundColor,
                  L = R && R.image;
                L &&
                  ((L = m.findExistImage(L)),
                  m.isImageReady(L) &&
                    (I = Math.max(I, (L.width * A) / L.height)));
              }
              var B = k ? k[1] + k[3] : 0;
              I += B;
              var E = null != v ? v - T : null;
              null != E &&
                E < I &&
                (!D || E < B
                  ? ((F.text = ""), (F.textWidth = I = 0))
                  : ((F.text = l(F.text, E - B, C, p.ellipsis, {
                      minChar: p.minChar
                    })),
                    (F.textWidth = n(F.text, C)),
                    (I = F.textWidth + B)));
            }
            (T += F.width = I), P && (b = Math.max(b, F.lineHeight));
          }
          (_.width = T), (_.lineHeight = b), (h += b), (u = Math.max(u, T));
        }
        (r.outerWidth = r.width = w(e.textWidth, u)),
          (r.outerHeight = r.height = w(e.textHeight, h)),
          d && ((r.outerWidth += d[1] + d[3]), (r.outerHeight += d[0] + d[2]));
        for (x = 0; x < c.length; x++) {
          var F,
            z = (F = c[x]).percentWidth;
          F.width = (parseInt(z, 10) / 100) * u;
        }
        return r;
      }
      function g(t, e, r) {
      ...
      (e.DEFAULT_FONT = C),
        ...
        (e.getWidth = n),
        (e.getBoundingRect = function(t, e, r, n, o, s, l, h) {
          return l ? a(t, e, r, n, o, s, l, h) : i(t, e, r, n, o, s, h);
        }),
        (e.adjustTextX = o),
        (e.adjustTextY = s),
        ...
        (e.makeFont = function(t) {
          ...
          return (e && T(e)) || t.textFont || t.font;
        });
    },
    function(t, e) {
    ...
    function(t, e) {
      ...
      (e.subPixelOptimizeLine = function(t, e, i) {
        ...
        (e.subPixelOptimizeRect = function(t, e, n) {
          var i = n && n.lineWidth;
          if (e && i) {
            var a = e.x,
              o = e.y,
            ...
            (t.x = r(a, i, !0)),
              (t.y = r(o, i, !0)),
              (t.width = Math.max(r(a + s, i, !1) - t.x, 0 === s ? 0 : 1)),
              (t.height = Math.max(r(o + l, i, !1) - t.y, 0 === l ? 0 : 1));
          }
        }),
    ...
    function(t, e, r) {
      ...
      var i = r(0),
        ...
        u = i.isObject,
        c = i.clone,
        f = r(12).normalizeToArray,
        d = r(33).guessOrdinal,
        p = r(14),
        v = r(37).OTHER_DIMENSIONS,
        g = function(t, e, r) {
          function i(t, e, r) {
            null != v.get(e)
              ? (t.otherDims[e] = r)
              : ((t.coordDim = e), (t.coordDimIndex = r), x.set(e, !0));
          }
          p.isInstance(e) || (e = p.seriesDataToSource(e)),
            (r = r || {}),
            (t = (t || []).slice());
          for (
            var g = (r.dimsDef || []).slice(),
              y = a(r.encodeDef),
              m = a(),
              x = a(),
              _ = [],
            ...
            var S = (g[w] = h({}, u(g[w]) ? g[w] : { name: g[w] })),
              T = S.name,
              M = (_[w] = { otherDims: {} });
            null != T &&
              null == m.get(T) &&
              ((M.name = M.displayName = T), m.set(T, w)),
              null != S.type && (M.type = S.type),
              null != S.displayName && (M.displayName = S.displayName);
          }
          y.each(function(t, e) {
            if (1 === (t = f(t).slice()).length && t[0] < 0) y.set(e, !1);
            else {
              var r = y.set(e, []);
              o(t, function(t, n) {
                s(t) && (t = m.get(t)),
                  null != t && t < b && ((r[n] = t), i(_[t], e, n));
              });
            }
          });
          var P = 0;
          o(t, function(t, e) {
            ...
            if (!1 !== (d = y.get(r))) {
              var d;
              if (!(d = f(d)).length)
                for (var p = 0; p < ((n && n.length) || 1); p++) {
                  for (; P < _.length && null != _[P].coordDim; ) P++;
                  P < _.length && d.push(P++);
                }
              o(d, function(e, o) {
                var s = _[e];
                if ((i(l(s, t), r, o), null == s.name && n)) {
                  var h = n[o];
                  !u(h) && (h = { name: h }),
                    (s.name = s.displayName = h.name),
                    (s.defaultTooltip = h.defaultTooltip);
                }
                a && l(s.otherDims, a);
              });
            }
          });
          var k = r.generateCoord,
            O = r.generateCoordCount,
            C = null != O;
          O = k ? O || 1 : 0;
          for (var A = k || "value", I = 0; I < b; I++)
            null == (M = _[I] = _[I] || {}).coordDim &&
              ((M.coordDim = n(A, x, C)),
              (M.coordDimIndex = 0),
              (!k || O <= 0) && (M.isExtraCoord = !0),
              O--),
              null == M.name && (M.name = n(M.coordDim, m)),
              null == M.type && d(e, I, M.name) && (M.type = "ordinal");
          return _;
        };
      t.exports = g;
    },
    function(t, e, r) {
      function n(t, e, r, n, o) {
        if (!t) return { dimensionsDefine: i(o) };
        var s, l, h, c;
        if (e === M)
          "auto" === n || null == n
            ? a(
            ...
            (s = o ? o.length : r === A ? t.length : t[0] ? t[0].length : null);
        else if (e === P)
          o ||
            ((o = (function(t) {
        ...
        return (
          h &&
            p(o, function(t, e) {
              "name" === (m(t) ? t.name : t) && (c = e);
            }),
          {
            startIndex: l,
            dimensionsDefine: i(o),
            dimensionsDetectCount: s,
      ...
      function i(t) {
        if (t) {
          ...
          return v(t, function(t, r) {
            if (null == (t = b({}, m(t) ? t : { name: t })).name) return t;
            (t.name += ""), null == t.displayName && (t.displayName = t.name);
            var n = e.get(t.name);
            return (
              n ? (t.name += "-" + n.count++) : e.set(t.name, { count: 1 }), t
            );
          });
        }
      }
      ...
      function o(t, e, r, n, i, a) {
        ...
        if (o && null != g.get(f)) {
          var y = t.ecModel,
            m = I(y).datasetMap,
            x = e.uid + "_" + i,
            _ = m.get(x) || m.set(x, { categoryWayDim: 1, valueWayDim: 0 });
          p(o.coordSysDims, function(t) {
            if (null == o.firstCategoryDimIndex) {
              var e = _.valueWayDim++;
              (l[t] = e), u.push(e);
            } else if (o.categoryAxisMap.get(t)) (l[t] = 0), h.push(0);
            else {
              e = _.categoryWayDim++;
              (l[t] = e), u.push(e);
            }
          });
        } else if (null != v.get(f)) {
          for (var b, w = 0; w < 5 && null == b; w++)
            s(r, n, i, a.dimensionsDefine, a.startIndex, w) || (b = w);
          if (null != b) {
            l.value = b;
            var S = a.potentialNameDimIndex || Math.max(b - 1, 0);
            u.push(S), h.push(S);
          }
        }
        return h.length && (l.itemName = h), u.length && (l.seriesName = u), l;
      }
      function s(t, e, r, n, i, a) {
        ...
        var s, l;
        if (x(t)) return !1;
        if ((n && ((l = n[a]), (l = m(l) ? l.name : l)), e === M))
          if (r === A) {
            for (var h = t[a], c = 0; c < (h || []).length && c < 5; c++)
              if (null != (s = o(h[i + c]))) return s;
          } else
          ...
          if (!l) return;
          for (c = 0; c < t.length && c < 5; c++) {
            if ((d = t[c]) && null != (s = o(d[l]))) return s;
          }
        } else if (e === k) {
          if (!l) return;
          if (!(h = t[l]) || x(h)) return !1;
      ...
      var l = (r(6).__DEV__, r(12)),
        h = l.makeInner,
        u = l.getDataItemValue,
        c = r(35).getCoordSysDefineBySeries,
        f = r(0),
        d = f.createHashMap,
        p = f.each,
        v = f.map,
        ...
        w = (f.assert, r(14)),
        S = r(15),
        T = S.SOURCE_FORMAT_ORIGINAL,
        M = S.SOURCE_FORMAT_ARRAY_ROWS,
        P = S.SOURCE_FORMAT_OBJECT_ROWS,
        k = S.SOURCE_FORMAT_KEYED_COLUMNS,
        O = S.SOURCE_FORMAT_UNKNOWN,
        C = S.SOURCE_FORMAT_TYPED_ARRAY,
        A = S.SERIES_LAYOUT_BY_ROW,
        I = h();
        ...
        (e.prepareSource = function(t) {
          ...
          if (u) {
            ...
            (r = c.source),
              (i = I(u).sourceFormat),
              (a = !0),
              (s = s || c.seriesLayoutBy),
              null == l && (l = c.sourceHeader),
              (h = h || c.dimensions);
          }
          var f = n(r, i, s, l, h),
            d = e.encode;
        ...
        s = {
          cartesian2d: function(t, e, r, i) {
            ...
            (e.coordSysDims = ["x", "y"]),
              r.set("x", a),
              r.set("y", o),
              n(a) && (i.set("x", a), (e.firstCategoryDimIndex = 0)),
              n(o) && (i.set("y", o), (e.firstCategoryDimIndex = 1));
          },
          singleAxis: function(t, e, r, i) {
            var a = t.getReferringComponents("singleAxis")[0];
            (e.coordSysDims = ["single"]),
              r.set("single", a),
              n(a) && (i.set("single", a), (e.firstCategoryDimIndex = 0));
          },
          polar: function(t, e, r, i) {
            ...
            (e.coordSysDims = ["radius", "angle"]),
              r.set("radius", o),
              r.set("angle", s),
              n(o) && (i.set("radius", o), (e.firstCategoryDimIndex = 0)),
              n(s) && (i.set("angle", s), (e.firstCategoryDimIndex = 1));
          },
          ...
          parallel: function(t, e, r, i) {
            var a = t.ecModel,
              s = a.getComponent("parallel", t.get("parallelIndex")),
              l = (e.coordSysDims = s.dimensions.slice());
            o(s.parallelAxisIndex, function(t, o) {
              var s = a.getComponent("parallelAxis", t),
                h = l[o];
              r.set(h, s),
                n(s) &&
                  null == e.firstCategoryDimIndex &&
                  (i.set(h, s), (e.firstCategoryDimIndex = o));
            });
          }
        };
    ...
    function(t, e, r) {
      function n(t) {
        var e = { main: "", sub: "" };
        return (
          t && ((t = t.split(s)), (e.main = t[0] || ""), (e.sub = t[1] || "")),
          e
        );
      }
      function i(t, e) {
    ...
    function(t, e, r) {
      ...
      (e.OTHER_DIMENSIONS = o),
        (e.summarizeDimensions = function(t) {
          ...
          var f = r.tooltip;
          return (
            f && f.length ? (l = f.slice()) : l.length || (l = s.slice()),
            (r.defaultedLabel = s),
      ...
      n.extendChartView({
        ...
        render: function(t, e, r) {
          function i(t, e) {
            if (O) {
              if (0 === O.indexOf("path://")) {
                var r = n.graphic.makePath(O.slice(7), {}),
                  i = r.getBoundingRect(),
                  o = i.width,
                  s = i.height;
                o > s
              ...
              (u = e ? -t : M - t), (c = e ? -t : P - t);
              return (
                "pin" === O ? (c += t) : "arrow" === O && (c -= t),
                a.createSymbol(O, u, c, 2 * t, 2 * t)
              );
            }
            return new n.graphic.Circle({
              shape: { cx: e ? 0 : M, cy: e ? 0 : P, r: t }
            });
          }
          function l() {
            var e = i(w);
          ...
          function h(e, r, a) {
            var l = k ? v[0] : v,
              h = k ? y / 2 : v,
              u = f.getItemModel(e),
              c = u.getModel("itemStyle"),
              d = u.get("phase"),
              p = o(u.get("amplitude"), 2 * h),
              g = o(u.get("waveLength"), 2 * l),
              m = h - f.get("value", e) * h * 2;
            d = a ? a.shape.phase : "auto" === d ? (e * Math.PI) / 4 : d;
            ...
            w.shape._waterLevel = m;
            var S = u.getModel("emphasis.itemStyle").getItemStyle();
            (S.lineWidth = 0), n.graphic.setHoverStyle(w, S);
            var T = i(v, !0);
            return T.setStyle({ fill: "white" }), w.setClipPath(T), w;
          }
          function u(t, e, r) {
            var n = f.getItemModel(t),
              i = n.get("period"),
              a = n.get("direction"),
              o = f.get("value", t),
              s = n.get("phase");
          ...
          var f = t.getData(),
            ...
            x = 0,
            _ = 0,
            b = t.get("outline.show");
          b &&
            ((x = t.get("outline.borderDistance")),
            (_ = o(t.get("outline.itemStyle.borderWidth"), m)));
          var w,
            S,
            T,
            M = o(p[0], g),
          ...
          ("container" === O
            ? ((k = !0),
              (S = [(w = [g / 2, y / 2])[0] - _ / 2, w[1] - _ / 2]),
              (T = [o(x, g), o(x, y)]),
              (v = [Math.max(S[0] - T[0], 0), Math.max(S[1] - T[1], 0)]))
            : ((S = (w = o(v, m) / 2) - _ / 2),
              (T = o(x, m)),
              (v = Math.max(S - T, 0))),
          b) && ((l().style.lineWidth = _), c.add(l()));
          var C = k ? 0 : M - v,
            A = k ? 0 : P - v,
            I = null;
          c.add(
          ...
          f
            ...
            .add(function(e) {
              ...
              (r.shape.waterLevel = k ? y / 2 : v),
                n.graphic.initProps(r, { shape: { waterLevel: i } }, t),
                (r.z2 = 2),
                u(e, r, null),
                c.add(r),
            ...
            .update(function(e, r) {
              for (
                ...
                var d = s[l];
                a.shape.hasOwnProperty(d) && (o[d] = a.shape[d]);
              }
              var p = {},
                v = ["fill", "opacity", "shadowBlur", "shadowColor"];
              for (l = 0; l < v.length; ++l) {
                d = v[l];
                a.style.hasOwnProperty(d) && (p[d] = a.style[d]);
              }
              k && (o.radiusY = y / 2),
                n.graphic.updateProps(i, { shape: o, style: p }, t),
                (i.position = a.position),
                i.setClipPath(a.clipPath),
                (i.shape.inverse = a.inverse),
                u(e, i, i),
                c.add(i),
                f.setItemGraphicEl(e, i),
                R.push(i);
            })
            .remove(function(t) {
              ...
              c.add(
                (function(e) {
                  var r = d.getModel("label"),
                      ...
                      style: {
                        ...
                        text: (function() {
                          var e = t.getFormattedLabel(0, "normal"),
                            r = 100 * f.get("value", 0),
                            n = f.getName(0) || t.name;
                          return (
                            isNaN(r) || (n = r.toFixed(0) + "%"),
                            null == e ? n : e
                          );
                        })(),
                    ...
                    o = new n.graphic.Rect(a),
                    s = r.get("color");
                  n.graphic.setText(o.style, r, s);
                  var l = new n.graphic.Rect(a),
                    h = r.get("insideColor");
                  n.graphic.setText(l.style, r, h), (l.style.textFill = h);
                  var u = new n.graphic.Group();
                  u.add(o), u.add(l);
                  var c = i(v, !0);
                  return (
                    (I = new n.graphic.CompoundPath({
                      shape: { paths: e },
                      position: [M, P]
                    })).setClipPath(c),
                    l.setClipPath(I),
    ...
    function(t, e, r) {
      ...
      e.createSymbol = function(t, e, r, i, s, l, h) {
        var u,
          c = 0 === t.indexOf("empty");
        return (
          ...
          ((u =
            0 === t.indexOf("image://")
              ...
              : new p({
                  shape: { symbolType: t, x: e, y: r, width: i, height: s }
                })).__isEmptyBrush = c),
          (u.setColor = n),
          u.setColor(l),
          u
    ...
    function(t, e, r) {
      function n(t, e, r, n) {
        var o = O.createFromString(t, e);
        return (
          r && ("center" === n && (r = i(r, o.getBoundingRect())), a(o, r)), o
        );
      }
      function i(t, e) {
        var r,
          ...
          i = t.height * n;
        return (
          i <= t.width ? (r = t.height) : (r = (i = t.width) / n),
          {
            x: t.x + t.width / 2 - i / 2,
      ...
      function l(t) {
        ...
        if (e && !t.__highlighted) {
          var r = t.useHoverLayer;
          t.__highlighted = r ? "layer" : "plain";
          var n = t.__zr;
          if (n || !r) {
            var i = t,
              a = t.style;
            r && (a = (i = n.addHover(t)).style),
              S(a),
              r ||
                (function(t) {
      ...
      function h(t, e, r) {
        !s(e[r]) &&
          ...
          (t[r] = (function(t) {
            ...
            var e = nt.get(t);
            return (
              e || ((e = C.lift(t, -0.1)), it < 1e4 && (nt.set(t, e), it++)), e
            );
          })(t[r]));
      }
      function u(t) {
        ...
        if (e)
          if (((t.__highlighted = !1), "layer" === e))
            ...
            n && (S(r), t.setStyle(n), w(r));
            var i = t.__cachedNormalZ2;
            null != i && t.z2 - i === et && (t.z2 = i);
          }
      }
      function c(t, e) {
        t.isGroup
      ...
      function f(t, e) {
        (e = t.__hoverStl = !1 !== e && (e || {})),
          (t.__hoverStlDirty = !0),
          t.__highlighted && ((t.__cachedNormalStl = null), u(t), l(t));
      }
      function d(t) {
        (this.__hoverSilentOnTouch && t.zrByTouch) ||
          (!this.__isEmphasisEntered && c(this, l));
      }
      function p(t) {
        (this.__hoverSilentOnTouch && t.zrByTouch) ||
          (!this.__isEmphasisEntered && c(this, u));
      }
      function v() {
        (this.__isEmphasisEntered = !0), c(this, l);
      }
      function g() {
        (this.__isEmphasisEntered = !1), c(this, u);
      }
      function y(t, e) {
        var r = !1 === e;
        if (
          ((t.__hoverSilentOnTouch = null != e && e.hoverSilentOnTouch),
          !r || t.__hoverStyleTrigger)
        ) {
          var n = r ? "off" : "on";
          t[n]("mouseover", d)[n]("mouseout", p),
            t[n]("emphasis", v)[n]("normal", g),
            (t.__hoverStyleTrigger = !r);
        }
      }
      function m(t, e, r, n, i) {
        return x(t, e, n, i), r && k.extend(t, r), t;
      }
      function x(t, e, r, n) {
        if ((r = r || tt).isRectText) {
      ...
      function _(t, e, r, n, i, a) {
        (r = (!i && r) || tt),
          (t.textFill = b(e.getShallow("color"), n) || r.color),
          (t.textStroke =
            b(e.getShallow("textBorderColor"), n) || r.textBorderColor),
          (t.textStrokeWidth = k.retrieve2(
            e.getShallow("textBorderWidth"),
            r.textBorderWidth
          )),
          (t.insideRawTextPosition = t.textPosition),
          i ||
            (a && ((t.insideRollbackOpt = n), w(t)),
          ...
          (a && n.disableBox) ||
            ((t.textBackgroundColor = b(e.getShallow("backgroundColor"), n)),
            (t.textPadding = e.getShallow("padding")),
            (t.textBorderColor = b(e.getShallow("borderColor"), n)),
      ...
      function w(t) {
        ...
        if (e && null == t.textFill) {
          ...
          (!0 === n ||
            ...
            : null != a && ((r = { textFill: null }), (t.textFill = a)),
            r && (t.insideRollback = r);
        }
      }
      function S(t) {
      ...
      function P(t, e, r) {
        return (
          e && !k.isArrayLike(e) && (e = R.getLocalTransform(e)),
          r && (e = A.invert([], e)),
      ...
      var $ = Math.round,
        ...
        nt = k.createHashMap(),
        it = 0;
      (e.Z2_EMPHASIS_LIFT = et),
        (e.extendShape = function(t) {
          return D.extend(t);
        }),
        (e.extendPath = function(t, e) {
          return O.extendFromString(t, e);
        }),
        (e.makePath = n),
        ...
        (e.subPixelOptimizeLine = function(t) {
          var e = t.shape,
            r = t.style.lineWidth;
          return (
            $(2 * e.x1) === $(2 * e.x2) && (e.x1 = e.x2 = o(e.x1, r, !0)),
            $(2 * e.y1) === $(2 * e.y2) && (e.y1 = e.y2 = o(e.y1, r, !0)),
            t
          );
        }),
        (e.subPixelOptimizeRect = function(t) {
          ...
          return (
            (e.x = o(e.x, r, !0)),
            (e.y = o(e.y, r, !0)),
            (e.width = Math.max(o(n + a, r, !1) - e.x, 0 === a ? 0 : 1)),
            (e.height = Math.max(o(i + s, r, !1) - e.y, 0 === s ? 0 : 1)),
            t
          );
        }),
        (e.subPixelOptimize = o),
        (e.setElementHoverStyle = f),
        (e.isInEmphasis = function(t) {
          return t && t.__isEmphasisEntered;
        }),
        (e.setHoverStyle = function(t, e, r) {
          t.isGroup
            ? t.traverse(function(t) {
                !t.isGroup && f(t, t.hoverStyle || e);
              })
            : f(t, t.hoverStyle || e),
            y(t, r);
        }),
        (e.setAsHoverStyleTrigger = y),
        (e.setLabelStyle = function(t, e, r, n, i, a, o) {
          var s,
            l = (i = i || tt).labelFetcher,
            h = i.labelDataIndex,
            u = i.labelDimIndex,
            c = r.getShallow("show"),
            f = n.getShallow("show");
          (c || f) &&
            (l && (s = l.getFormattedLabel(h, "normal", null, u)),
            null == s &&
              (s = k.isFunction(i.defaultText)
                ? i.defaultText(h, i)
                : i.defaultText));
          var d = c ? s : null,
            p = f
              ? k.retrieve2(
                  l ? l.getFormattedLabel(h, "emphasis", null, u) : null,
                  s
                )
              : null;
          (null == d && null == p) || (m(t, r, a, i), m(e, n, o, i, !0)),
            (t.text = d),
            (e.text = p);
        }),
        (e.setTextStyle = m),
        (e.setText = function(t, e, r) {
          var n,
            i = { isRectText: !0 };
          !1 === r ? (n = !0) : (i.autoColor = r), x(t, e, i, n);
        }),
        ...
        (e.getTransform = function(t, e) {
          for (var r = A.identity([]); t && t !== e; )
            A.mul(r, t.getLocalTransform(), r), (t = t.parent);
          return r;
        }),
        (e.applyTransform = P),
        ...
        (e.groupTransition = function(t, e, r, n) {
          function i(t) {
            var e = { position: I.clone(t.position), rotation: t.rotation };
            return t.shape && (e.shape = k.extend({}, t.shape)), e;
          }
          if (t && e) {
            var a = (function(t) {
              var e = {};
            ...
            e.traverse(function(t) {
              if (!t.isGroup && t.anid) {
                ...
                if (e) {
                  var n = i(t);
                  t.attr(i(e)), M(t, n, r, t.dataIndex);
                }
              }
            });
          }
        ...
        (e.clipPointsByRect = function(t, e) {
          return k.map(t, function(t) {
            var r = t[0];
            (r = K(r, e.x)), (r = J(r, e.x + e.width));
            var n = t[1];
            return (n = K(n, e.y)), [r, (n = J(n, e.y + e.height))];
          });
        }),
        (e.clipRectByRect = function(t, e) {
          var r = K(t.x, e.x),
            n = J(t.x + t.width, e.x + e.width),
            i = K(t.y, e.y),
            a = J(t.y + t.height, e.y + e.height);
          if (n >= r && a >= i)
            return { x: r, y: i, width: n - r, height: a - i };
        }),
        (e.createIcon = function(t, e, r) {
          var i = ((e = k.extend({ rectHover: !0 }, e)).style = {
            strokeNoScale: !0
          });
          if (((r = r || { x: -1, y: -1, width: 2, height: 2 }), t))
            return 0 === t.indexOf("image://")
              ? ((i.image = t.slice(8)), k.defaults(i, r), new L(e))
              : n(t.replace("path://", ""), e, r, "center");
        });
    },
    function(t, e, r) {
      function n(t, e, r, n, i, a, o, s, f, v, g) {
        var y = f * (c / 180),
          m = (u(y) * (t - r)) / 2 + (h(y) * (e - n)) / 2,
          x = (-1 * h(y) * (t - r)) / 2 + (u(y) * (e - n)) / 2,
          _ = (m * m) / (o * o) + (x * x) / (s * s);
        _ > 1 && ((o *= l(_)), (s *= l(_)));
        var b =
            (i === a ? -1 : 1) *
              l(
                (o * o * (s * s) - o * o * (x * x) - s * s * (m * m)) /
                  (o * o * (x * x) + s * s * (m * m))
              ) || 0,
          w = (b * o * x) / s,
          S = (b * -s * m) / o,
        ...
        var r = (function(t) {
          ...
          for (
            ...
            for (var _ = 0; _ < m; ) {
              ...
              switch (p) {
                case "l":
                  (r += y[_++]), (i += y[_++]), (f = h.L), l.addData(f, r, i);
                  break;
                case "L":
                  (r = y[_++]), (i = y[_++]), (f = h.L), l.addData(f, r, i);
                  break;
                ...
                case "M":
                  ...
                  break;
                case "h":
                  (r += y[_++]), (f = h.L), l.addData(f, r, i);
                  break;
                case "H":
                  (r = y[_++]), (f = h.L), l.addData(f, r, i);
                  break;
                case "v":
                  (i += y[_++]), (f = h.L), l.addData(f, r, i);
                  break;
                case "V":
                  (i = y[_++]), (f = h.L), l.addData(f, r, i);
                  break;
                ...
                case "S":
                  ...
                  var A = l.len(),
                    I = l.data;
                  e === h.C && ((b += r - I[A - 4]), (w += i - I[A - 3])),
                    (f = h.C),
                    (O = y[_++]),
                    (C = y[_++]),
                    (r = y[_++]),
                    (i = y[_++]),
                    l.addData(f, b, w, O, C, r, i);
                  break;
                case "s":
                  (b = r),
                    (w = i),
        ...
        var a = r(16),
          ...
          h = (l.prototype = {
            ...
            bind: function(t, e, r) {
              var n = this,
                i = r && r.style,
                l = !i || t.__attrCachedBy !== o.STYLE_BIND;
              t.__attrCachedBy = o.STYLE_BIND;
              for (var h = 0; h < s.length; h++) {
                var u = s[h],
                  c = u[0];
                (l || n[c] !== i[c]) && (t[c] = a(t, c, n[c] || u[1]));
              }
              if (
                ((l || n.fill !== i.fill) && (t.fillStyle = n.fill),
                (l || n.stroke !== i.stroke) && (t.strokeStyle = n.stroke),
                (l || n.opacity !== i.opacity) &&
    ...
    function(t, e) {
      function r(t, e, r, n, i, a) {
        var o = t._$handlers;
        if (
          ("function" == typeof r && ((i = n), (n = r), (r = null)), !n || !e)
        )
          return t;
        (r = (function(t, e) {
          var r = t._$eventProcessor;
          return (
            null != e && r && r.normalizeQuery && (e = r.normalizeQuery(e)), e
          );
        })(t, r)),
          o[e] || (o[e] = []);
      ...
      i.prototype = {
        ...
        one: function(t, e, n, i) {
          return r(this, t, e, n, i, !0);
        },
        on: function(t, e, n, i) {
          return r(this, t, e, n, i, !1);
        },
        isSilent: function(t) {
        ...
        triggerWithContext: function(t) {
          ...
          if (e) {
            var i = arguments,
              a = i.length;
            a > 4 && (i = n.call(i, 1, i.length - 1));
            for (var o = i[i.length - 1], s = e.length, l = 0; l < s; ) {
              var h = e[l];
              if (r && r.filter && null != h.query && !r.filter(t, h.query))
                l++;
              else {
                switch (a) {
                  case 1:
    ...
    function(t, e, r) {
      function n(t, e, r, n, a, o, s, l) {
        ...
        var f = t.animators.slice(),
          d = f.length;
        d || (o && o());
        for (var p = 0; p < f.length; p++) f[p].done(c).start(a, s);
      }
      function i(t, e, r, n, o, s, l) {
        var h = {},
          u = 0;
        for (var d in n)
          n.hasOwnProperty(d) &&
            (null != r[d]
              ? c(n[d]) && !f(n[d])
                ? i(t, e ? e + "." + d : d, r[d], n[d], o, s, l)
                : (l ? ((h[d] = r[d]), a(t, e, d, n[d])) : (h[d] = n[d]), u++)
              : null == n[d] || l || a(t, e, d, n[d]));
        u > 0 &&
          t
            .animate(e, !1)
            .when(null == o ? 500 : o, h)
      ...
      p.prototype = {
        ...
        animate: function(t, e) {
          ...
          if (t) {
            var l = t.split("."),
              h = i;
            n = "shape" === l[0];
            for (var u = 0, c = l.length; u < c; u++) h && (h = h[l[u]]);
            h && (r = h);
          } else r = i;
          if (r) {
            var f = i.animators,
            ...
            return (
              ...
              f.push(p),
              a && a.animation.addAnimator(p),
              p
            );
          }
          s('Property "' + t + '" is not existed in element ' + i.id);
        },
        ...
        animateTo: function(t, e, r, i, a, o) {
          n(this, t, e, r, i, a, o);
        },
        animateFrom: function(t, e, r, i, a, o) {
          n(this, t, e, r, i, a, o, !0);
        }
      };
      var v = p;
      t.exports = v;
    ...
    function(t, e, r) {
      ...
      function l(t, e, r) {
        ...
        if (n !== i)
          if (n > i) t.length = i;
            ...
            for (var a = n; a < i; a++) t.push(1 === r ? e[a] : m.call(e[a]));
      ...
      function f(t) {
        if (y(t)) {
          var e = t.length;
          if (y(t[0])) {
            for (var r = [], n = 0; n < e; n++) r.push(m.call(t[n]));
            return r;
          }
          return m.call(t);
        }
      ...
      function p(t, e, r, n, i, f) {
        ...
        if (_) {
          ...
          n.sort(function(t, e) {
            ...
            (b = n[_ - 1].time);
          for (var k = [], O = [], C = n[0].value, A = !0, I = 0; I < _; I++) {
            k.push(n[I].time / b);
            var D = n[I].value;
            if (
              ((S && h(D, C, P)) || (!S && D === C) || (A = !1),
          ...
          if (f || !A) {
            ...
            for (I = 0; I < _ - 1; I++)
              S
                ? l(O[I], L, P)
                : !isNaN(O[I]) || isNaN(L) || M || T || (O[I] = L);
            S && l(p(t._target, i), L, P);
            var B,
              E,
              F,
              z,
            ...
            var H = new v({
              ...
              onframe: function(t, e) {
                ...
                if (e < 0) r = 0;
                  ...
                  for (r = Math.min(W + 1, _ - 1); r >= 0 && !(k[r] <= e); r--);
                  r = Math.min(r, _ - 2);
                } else {
                  for (r = W; r < _ && !(k[r] > e); r++);
                  r = Math.min(r - 1, _ - 2);
                ...
                if (0 !== n)
                  if (((B = (e - k[r]) / n), x))
                    if (
                      ...
                      u(E, F, z, N, B, B * B, B * B * B, p(t, i), P);
                    else {
                      if (T)
                        (l = u(E, F, z, N, B, B * B, B * B * B, j, 1)),
                          (l = d(j));
                      else {
                        if (M) return o(F, z, B);
                        l = c(E, F, z, N, B, B * B, B * B * B);
                      }
                      m(t, i, l);
                    }
                  else if (S) s(O[r], O[r + 1], B, p(t, i), P);
                  else {
                    var l;
                    if (T) s(O[r], O[r + 1], B, j, 1), (l = d(j));
                    else {
                      if (M) return o(O[r], O[r + 1], B);
                      l = a(O[r], O[r + 1], B);
                    }
                    m(t, i, l);
                  }
      ...
      (e.fromPoints = function(t, e, r) {
        ...
        (e.fromCubic = function(t, e, r, n, s, l, h, u, c, f) {
          var v,
            ...
            m = g(t, r, s, h, d);
          for (
            c[0] = 1 / 0, c[1] = 1 / 0, f[0] = -1 / 0, f[1] = -1 / 0, v = 0;
            v < m;
            v++
          ) {
            var x = y(t, r, s, h, d[v]);
    ...
    function(t, e, r) {
      ...
      function a(t, e, r, n, a, o, s, l, h, u) {
        if (
          ...
          return 0;
        var c = v.cubicRootAt(e, n, o, l, u, _);
        if (0 === c) return 0;
        for (var f, d, p = 0, g = -1, y = 0; y < c; y++) {
          var m = _[y],
            x = 0 === m || 1 === m ? 0.5 : 1;
          v.cubicAt(t, r, a, s, m) < h ||
            (g < 0 &&
              ((g = v.cubicExtrema(e, n, o, l, b)),
              b[1] < b[0] && g > 1 && i(),
              (f = v.cubicAt(e, n, o, l, b[0])),
              g > 1 && (d = v.cubicAt(e, n, o, l, b[1]))),
            (p +=
              2 === g
                ? m < b[0]
                  ? f < e
      ...
      function o(t, e, r, n, i, a, o, s) {
        ...
        var l = v.quadraticRootAt(e, n, a, s, _);
        if (0 === l) return 0;
        var h = v.quadraticExtremum(e, n, a);
        if (h >= 0 && h <= 1) {
          for (var u = 0, c = v.quadraticAt(e, n, a, h), f = 0; f < l; f++) {
            var d = 0 === _[f] || 1 === _[f] ? 0.5 : 1;
            v.quadraticAt(t, r, i, _[f]) < o ||
              (u += _[f] < h ? (c < e ? d : -d) : a < c ? d : -d);
          }
          return u;
        }
        d = 0 === _[0] || 1 === _[0] ? 0.5 : 1;
        return v.quadraticAt(t, r, i, _[0]) < o ? 0 : a < e ? d : -d;
      }
      ...
      function l(t, e, r, i, l) {
        for (var h = 0, p = 0, v = 0, m = 0, x = 0, _ = 0; _ < t.length; ) {
          var b = t[_++];
          switch (
            (b === y.M && _ > 1 && (r || (h += g(p, v, m, x, i, l))),
            1 === _ && ((m = p = t[_]), (x = v = t[_ + 1])),
            b)
          ) {
            case y.M:
              (p = m = t[_++]), (v = x = t[_++]);
            ...
            case y.L:
              if (r) {
                if (u.containStroke(p, v, t[_], t[_ + 1], e, i, l)) return !0;
              } else h += g(p, v, t[_], t[_ + 1], i, l) || 0;
              (p = t[_++]), (v = t[_++]);
              break;
            case y.C:
              if (r) {
            ...
            case y.Q:
              if (r) {
                if (
                  f.containStroke(p, v, t[_++], t[_++], t[_], t[_ + 1], e, i, l)
                )
                  return !0;
              } else h += o(p, v, t[_++], t[_++], t[_], t[_ + 1], i, l) || 0;
              (p = t[_++]), (v = t[_++]);
              break;
            case y.A:
              var w = t[_++],
              ...
              var O = 1 - t[_++],
                C = Math.cos(P) * T + w,
                A = Math.sin(P) * M + S;
              _ > 1 ? (h += g(p, v, C, A, i, l)) : ((m = C), (x = A));
              var I = ((i - w) * M) / T + w;
              if (r) {
                if (d.containStroke(w, S, M, P, P + k, O, e, I, l)) return !0;
              } else h += s(w, S, M, P, P + k, O, I, l);
              (p = Math.cos(P + k) * T + w), (v = Math.sin(P + k) * M + S);
              break;
            case y.R:
              (m = p = t[_++]), (x = v = t[_++]);
              (C = m + t[_++]), (A = x + t[_++]);
              if (r) {
                if (
                  u.containStroke(m, x, C, x, e, i, l) ||
                  u.containStroke(C, x, C, A, e, i, l) ||
                  u.containStroke(C, A, m, A, e, i, l) ||
                  u.containStroke(m, A, m, x, e, i, l)
                )
                  return !0;
              } else (h += g(C, x, C, A, i, l)), (h += g(m, A, m, x, i, l));
              break;
            case y.Z:
              if (r) {
                if (u.containStroke(p, v, m, x, e, i, l)) return !0;
              } else h += g(p, v, m, x, i, l);
              (p = m), (v = x);
          }
        }
        return r || n(v, x) || (h += g(p, v, m, x, i, l) || 0), 0 !== h;
      }
      var h = r(9),
        u = r(53),
        c = r(54),
    ...
    function(t, e) {
      e.containStroke = function(t, e, r, n, i, a, o) {
        ...
        if (
          ...
          return !1;
        if (t === r) return Math.abs(a - t) <= l / 2;
        var h = (s = (e - n) / (t - r)) * a - o + (t * n - r * e) / (t - r);
          ...
          return (
            ...
            o.needDrawText(n, r)
              ? (this.setTransform(t),
                ...
                void this.restoreTransform(t))
              : void (t.__attrCachedBy = s.NONE)
          );
        },
        getBoundingRect: function() {
          var t = this.style;
                ...
                for (var a = 0; a < r.length; a++) {
                  ...
                  if (
                    ...
                    for (var h = 0; h < i.length; h++)
                      (i[h][2] = n[i[h][0]]), (n[i[h][0]] = i[h][1]);
                    e = !0;
                    break;
                  }
                }
              if ((t.apply(this, arguments), e))
                for (h = 0; h < i.length; h++) n[i[h][0]] = i[h][2];
            }
          : t;
      };
    },
      ...
      t.exports = function(t, e) {
        ...
        for (l = l < r ? r : l, s = 0; s < l; s++) {
          ...
          var g = p * p,
            y = p * g;
          a.push([
            n(h[0], v[0], u[0], c[0], p, g, y),
            n(h[1], v[1], u[1], c[1], p, g, y)
          ]);
        }
        return a;
      };
    ...
    function(t, e, r) {
      ...
      t.exports = function(t, e, r, n) {
        ...
        for (x = 0, _ = t.length; x < _; x++) {
          ...
          var M = l([], b, y),
            P = l([], b, m);
          n && (a(M, M, d), i(M, M, p), a(P, P, d), i(P, P, p)),
            v.push(M),
            v.push(P);
        }
          ...
          buildPath: function(t, e) {
            ...
            this.subPixelOptimize
              ? (a(o, e, this.style),
                ...
                (o.r = e.r),
                (e = o))
              : ((r = e.x), (n = e.y), (s = e.width), (l = e.height)),
      ...
      (n.prototype.incremental = !0),
        ...
        (n.prototype.brush = function(t, e) {
          for (var r = this._cursor; r < this._displayables.length; r++) {
            (n = this._displayables[r]).beforeBrush && n.beforeBrush(t),
              n.brush(t, r === this._cursor ? null : this._displayables[r - 1]),
          ...
          for (r = 0; r < this._temporaryDisplayables.length; r++) {
            ...
            (n = this._temporaryDisplayables[r]).beforeBrush &&
              n.beforeBrush(t),
              n.brush(t, 0 === r ? null : this._temporaryDisplayables[r - 1]),
              n.afterBrush && n.afterBrush(t);
          }
      ...
      (n.prototype.getBoundingRect = function() {
        if (!this._rect) {
          for (
            ...
            r.needLocalTransform() && n.applyTransform(r.getLocalTransform(s)),
              t.union(n);
          }
          this._rect = t;
        }
          ...
          reset: function(t, e) {
            ...
            i.each(function(t) {
              ...
              r.each(function(e) {
                ...
                if (o) r.setItemVisual(e, "color", o);
                else {
                  var s =
                    r.getItemModel(e).get("itemStyle.color") ||
                    t.getColorFromPalette(
                      r.getName(e) || e + "",
                      t.__paletteScope,
                      r.count()
                    );
                  r.setItemVisual(e, "color", s),
                    null != a && i.setItemVisual(a, "color", s);
                }
              });
          }
        };
