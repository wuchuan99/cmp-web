  ...
  >
    ...
    >
      <el-form-item label="上传文件" prop="file">
        ...
        >
          <new-button type="upload" class="upload-btn">点击上传</new-button>
        </el-upload>
      </el-form-item>
...
import { upLoadSystemLicense } from "@/api/system/system-info";
export default {
  data() {
    return {
      form: {
  ...
  methods: {
    ...
    operateSystemLicense() {
      ...
      formData.append("authFile", this.form.file);
      return upLoadSystemLicense(formData).then(() => {});
    },
    beforeUpload(file) {
      console.log(file);
      const { name } = file;
