<template>
  <div class="controlExposedArea card" :class="{ animation }">
    <div class="title">{{ country?.name || "全球" }}工控系统暴露地区TOP10</div>
    <div class="body">
...
<script>
import { getRegionIcs } from "@/api/home";
export default {
  props: {
    animation: {
      type: Boolean,
  ...
  beforeDestroy() {
    ...
    this.$emit("over-load", ["control-exposed-area"]);
  }
};
</script>
